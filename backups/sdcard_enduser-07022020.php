											...
											<table class="table table-hover table-bordered">
													...
													<tbody>
														<tr>
															...
															<td>
																<input type="number" class="input form-control d1" min="0" step="1" max="1"  name="qty_shipped_1" id="qty_shipped_1" readonly>
															</td>
															<td>																
														...
														<tr>
															...
															<td>
																<input type="number" class="input form-control d2" min="0" step="1" max="1"   name="qty_shipped_2" id="qty_shipped_2" readonly>
															</td>
															<td>
														...
														<tr>
															...
															<td>
																<input type="number" class="input form-control d3" min="0" step="1" max="1"   name="qty_shipped_3" id="qty_shipped_3" readonly>
															</td>
															<td>
														...
														<tr>
															...
															<td>
																<input type="number" class="input form-control d4" min="0" step="1" max="1"   name="qty_shipped_4" id="qty_shipped_4" readonly>
															</td>
															<td>
