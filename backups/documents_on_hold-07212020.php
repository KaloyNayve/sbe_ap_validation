            ...
            <div class="card">
              <div class="card-header border-transparent">
                ...
                <div class="card-tools">
                 ...
                 <button class="btn3d btn btn-outline-primary btn-sm" onclick="del();" data-toggle="tooltip" data-placement="top" title="Delete Selected Invoice"><i class="fas fa-minus-circle"></i> </button>
                
                 <button class="btn3d btn btn-outline-primary btn-sm" onclick="history();" data-toggle="tooltip" data-placement="top" title="View Invoice History"><i class="fas fa-history"></i> </button>    
