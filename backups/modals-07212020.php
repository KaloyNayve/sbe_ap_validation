              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="document_type" id="document_type">                    
                    ...
                    <option value="Payroll and Benefits">Payroll and Benefits</option>
      ...
      <div class="modal fade" id="document_notes">
        <div class="modal-dialog modal-xl" id="document_notes-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Document Notes for invoice # <span id="document_notes-invoice_number"></span></h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
