...
<script>
	...
	function printLabel(data) {
        ...
        let total_qty = parseInt(data['qty_received_1']);

        if (data['qty_received_2']) {
           total_qty = total_qty + parseInt(data['qty_received_2']);
        }

        if (data['qty_received_3']) {
            total_qty = total_qty + parseInt(data['qty_received_3']);
        }

        if (data['qty_received_4']) {
            total_qty = total_qty + parseInt(data['qty_received_4']);
        }

		let myTable = `<table style='font-size: 8px;'>`;
		myTable += `<tr><td style='width:150px;'>${barcode}</td></tr>`;
		myTable += `<tr><td>${data['dispatch_number_1']}</td></tr>`;
        myTable += `<tr><td>ID: ${data['id']}</td></tr>`;
		myTable += `<tr><td>Date: ${data['date']}</td></tr>`;
		myTable += `<tr><td>Model: ${data['model_1']}</td></tr>`;
		myTable += `<tr><td>QTY: ${total_qty}</td></tr>`;
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    	<?php if(isset($_POST['status'])){ ?>
		 ...
		 <?php } ?>
		 <?php if(isset($_POST['data']) && $_POST['data'] != "") : ?>
			<script>
				const data = <?php echo $_POST['data']; ?>;
				// console.log(data);
				printLabel(data);
			</script>
		 <?php endif; ?>
	...
	<section class="content">
				...
				<form action="actions.php" method="post" autocomplete="off">
					...
					<div class="box box-success">
							<div class="box-header with-border">
									...
									<?php if(isset($_POST['data']) && $_POST['data'] != ""): ?>
										<button type="button" class="btn btn-primary pull-right" name="print_label" id="print_label" >Print Label</button>
									<?php endif; ?>	
							...
							<div class="box-body">
											...
											<table class="table table-hover table-bordered">
													...
													<tbody>
														<tr>
															...
															<td>
																<input type="number" class="input form-control d1 received" min="0" step="1" max="1"  name="qty_received_1" id="qty_received_1" data-id="1">
															</td>
															<td>
																<input type="number" class="input form-control d1" min="0" step="1" max="1"  name="qty_shipped_1" id="qty_shipped_1" >
															</td>
															<td>																
																<select name="upgraded_1" id="upgraded_1" class="input form-control d1 upgrade" data-id="1">
																		<option></option>
														...
														<tr>
															...
															<td>
																<input type="number" class="input form-control d2 received" min="0" step="1" max="1"  name="qty_received_2" id="qty_received_2" data-id="2">
															</td>
															<td>
																<input type="number" class="input form-control d2" min="0" step="1" max="1"   name="qty_shipped_2" id="qty_shipped_2" >
															</td>
															<td>
																<select name="upgraded_2" id="upgraded_2" class="input form-control d2 upgrade" data-id="2">
																		<option></option>
																		<option value="yes">yes</option>
																		<option value="no">no</option>
																</select>	
														...
														<tr>
															...
															<td>
																<input type="number" class="input form-control d3 received" min="0" step="1" max="1"  name="qty_received_3" id="qty_received_3" data-id="3">
															</td>
															<td>
																<input type="number" class="input form-control d3" min="0" step="1" max="1"   name="qty_shipped_3" id="qty_shipped_3" >
															</td>
															<td>
																<select name="upgraded_3" id="upgraded_3" class="input form-control d3 upgrade" data-id="3">
																		<option></option>
																		<option value="yes">yes</option>
																		<option value="no">no</option>
																</select>	
														...
														<tr>
															...
															<td>
																<input type="number" class="input form-control d4 received" min="0" step="1" max="1"  name="qty_received_4" id="qty_received_4" data-id="4">
															</td>
															<td>
																<input type="number" class="input form-control d4" min="0" step="1" max="1"   name="qty_shipped_4" id="qty_shipped_4" >
															</td>
															<td>
																<select name="upgraded_4" id="upgraded_4" class="input form-control d4 upgrade" data-id="4">
																		<option></option>
																		<option value="yes">yes</option>
																		<option value="no">no</option>
																</select>	
									...
									<div class="col-md-6">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="waybill" id="waybill" required readonly>
                                                <span class="input-group-btn">
                                                        <button class="btn btn-default" type="button" id="generateWaybill" disabled>Generate Waybill</button>
                                                </span>
                                            </div>                             
		...
		<div class="row">
			<div class="col-lg-6">
					<div class="box box-success">
						<div class="box-header with-border">
							<h3 class="box-title">Select date range to download report</h3>                
						</div>
						<div class="box-body">
							<form actions="actions.php" method="post" id="download_report">
									<div class='row form-group'>
										<div class='col-lg-4'>
											...
											<input type='text' autocomplete='off' name='date_from' class='form-control pull-right datepicker' required />
											</div>
										</div>
										...
										<div class='col-lg-4'>
											...
											<input type='text' autocomplete='off' name='date_to' class='form-control pull-right datepicker'  required/> 
											</div>
										</div>

										<div class='col-lg-4'>
											<input type='submit' name='download_misTAT' value='Download Report' class='btn btn-success downloadBtn' style="margin-top:20px;"> 
										</div>
				...
				<div class="box box-success">
					...
					<div class="box-body">
                        <input type='submit' id='dl_con_report' value='Stock and consumption Report' class='btn btn-success downloadBtn' >
                        <input type='submit' id='dl_client_data' value='Client data' class='btn btn-success downloadBtn' >  
					</div>
				</div>													
			</div>
			...
			<div class="col-lg-6">
				<div class="box box-success">
					...
					<div class="box-body">
						...
						<input class="form-control" type="text" id="dispatch_number" name="dispatch_number">
						</div>
						<div class="box-footer">
							<input type="button"  class="btn btn-success pull-right" name="reprintLabel"  id="reprintLabel"  value="Reprint Label"  />		
...
<script type='text/javascript'>
	...
	function submitHandler(event) {	
		...
		console.log(inputs_enabled);
		// // use reduce to see if active qty received has a value of < 0
		const validator = inputs_enabled.reduce(function(acc, i) {			
			const model = document.querySelector(`#received_model_${i.dataset.id}`).value;			
			if (i.value < 1 && model !== 'none') {
				return acc + 1;
			}
			return acc;
		}, 0);		
	...
	readonly.forEach((r) =>  r.disabled = true); 
		 ...
		 if (dispatch_number.length === 11 && !dispatchArr.includes(dispatch_number)) {
			 ...
			 $.ajax({
					...
					success: function(data){			
						...
						} else if (data === "already scanned") {
							alert("dispatch already scanned, please check again");
						} else if (data === 'dispatched number is blocked') {
							alert("dispatch number is blocked");
						} else {
	 ...
	 exchanged.forEach(ex => ex.addEventListener('change', e => {
		...
		const needToBeDisabled = document.querySelectorAll(`#qty_received_${id}, #qty_shipped_${id}, #upgraded_${id}`);
	 ...
	 // add change handler to received qty to display the same with qty shipped
	 // const rcvd = document.querySelectorAll('.received');
	 // rcvd.forEach(r => r.addEventListener("change", e => {
		//  const id = e.currentTarget.dataset.id;
		//  const value = e.currentTarget.value;		 
		//  document.querySelector(`#qty_shipped_${id}`).value = value;	
	 // }));
	...
	//  }));
	 ...
	 const printBtn = document.querySelector("#print_label");
	 if (printBtn !== null) { // check if printBtn is created
	...
	// add submit handler to download_report form
	const download_report = document.querySelector("#download_report");
	download_report.addEventListener('submit', e => {
		e.preventDefault();
		// console.log(download_report.date_from.value, download_report.date_from.value);
		window.open(`http://portal-us.sbe-usa.com/sony_us_operations/actions.php?download-sony_sdcard_report=1&date_from=${download_report.date_from.value}&date_to=${download_report.date_to.value}`,'_newtab');
	});

	// add submit handler on sonysd stock and consumption report
	const consumption_report = document.querySelector("#dl_con_report");
	consumption_report.addEventListener('click', e => {
		window.open(`http://portal-us.sbe-usa.com/sony_us_operations/actions.php?download-sdcard_consumption_report=1`,'_newtab');
	});

    // add submit handler to download sony sdcard shipped data
	const client_data = document.querySelector("#dl_client_data");
	client_data.addEventListener('click', e => {
		window.open(`http://portal-us.sbe-usa.com/sony_us_operations/actions-dev.php?download-client-data=1`,'_newtab');
	});



	// reprint label button
	const reprintLabel_btn = document.querySelector("#reprintLabel");
	reprintLabel_btn.addEventListener('click', e => {
		const dispatch_number = document.querySelector("#dispatch_number").value;
		$.ajax({
			type: "post",
			url: "actions.php",
			data: {
			...
			success: function(data){
				// console.log(data);
				if (data === 'not found') {
					alert(`dispatch number: ${dispatch_number} not found, please check again`);
				} else {
