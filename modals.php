      ...
      <div class="modal fade" id="change_invoice_number_modal">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Change Invoice Number</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form action="actions.php" method="post" autocomplete="off">
              <div class="modal-body">
                ...
                <input type="hidden" name="old_invoice_number" id="old_invoice_number" >
                <div class="form-group">
                  <label>Invoice Number:</label>
                  <input class="form-control" name="change_invoice_number" id="change_invoice_number" required>
                </div>
              </div>
              <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="submit" name="change_invoice_number_submit"  class="btn btn-primary">Save changes</button>
      ...
      <div class="modal fade" id="reassign_document_type-modal">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Reassign Document Type for invoice: <span id="reassign_document_type-invoice_number"></span></h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form action="actions.php" method="post" autocomplete="off" id="reassign_document_type-form">
              <div class="modal-body">
                <input type="hidden" name="page_url" value="<?php echo basename($_SERVER['PHP_SELF']); ?>">
                <input type="hidden" name="reassign_document_type-id" id="reassign_document_type-id" >                
                <div class="form-group">
                  <label>Document Type:</label>
                  <select name="reassign_document_type-document_type" id="reassign_document_type-document_type" class="form-control" required>
                    <option></option>
                    <option value="CEO">CEO</option>
                    <option value="Finance">Finance</option>
                    <option value="HR and Admin">HR and Admin</option>
                ...
                <div class="form-group">
                  <label>Reason for reassigning document type:</label>
                  <textarea class="form-control" name="reassign_document_type-comment" id="reassign_document_type-comment" cols="30" rows="10" required></textarea>
                </div>
              </div>
              <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="submit" name="reassign_document_type-submit"  class="btn btn-primary">Save changes</button>                
      ...
      <!-- Delete on hold comments with mandatory reason -->
      <div class="modal fade" id="delete_on-hold_documents-modal">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Enter reason for deleting invoice</span></h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form id="delete_on-hold_documents-form">
              <div class="modal-body">
                <input type="hidden" name="page_url" value="<?php echo basename($_SERVER['PHP_SELF']); ?>">
                <input type="hidden" name="delete_on-hold_documents-id" id="delete_on-hold_documents-id" >                
                <input type="hidden" name="delete_on-hold_documents-invoice_number" id="delete_on-hold_documents-invoice_number" > 
                <div class="form-group">
                  <label>Reason:</label>
                  <textarea class="form-control" name="delete_on-hold_documents-comment" id="delete_on-hold_documents-comment" cols="30" rows="10" required></textarea>
                </div>
              </div>
              <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="submit" name="delete_on-hold_documents-submit"  class="btn btn-primary">Delete Invoice</button> 
              </div>
            </form>
