              ...
              <div class="card-header border-transparent">
                ...
                <div class="card-tools">
                 ...
                 <div class="d-flex flex-wrap" id="buttonsPanel">
                    ...
                    <button class="panel-btn btn3d btn btn btn-outline-primary btn-sm" onclick="changeInvoiceNumber();" data-toggle="tooltip" data-placement="top" title="Change Invoice Number"><i class="fas fa-exchange-alt"></i> </button>
